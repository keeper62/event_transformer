...
class RNNLightning(pl.LightningModule):
    def __init__(self, 
        ...
        self._logger.info("Initializing RNNLightning model")
        ...
        self.rnn = nn.RNN(embedding_dim, hidden_dim, num_layers, 
                          ...
                          dropout=dropout, 
                          bidirectional=True)
        self._logger.info(f"Initialized RNN with hidden_dim={hidden_dim}, num_layers={num_layers}, nonlinearity={nonlinearity}")
